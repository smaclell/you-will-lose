...
$(function() {
  ...
  var gameDiv = $('#game');
  var initialWidth = gameDiv.width();
  var initialHeight = gameDiv.height();

  var game = new Phaser.Game(initialWidth, initialHeight, Phaser.AUTO, 'game');
  var person;
  var black = "#000000";
  var white = "#FCFCFC";
  var thud;
  ...
  var mainState = {
    ...
    create: function () {
      ...
      tileBackground = game.add.tileSprite(0, 0, game.world.width, game.world.height, 'backgroundBlack');
      ...
      this.gameMessageText = this.add.text(this.game.world.centerX, game.world.height * 0.7, 'You will lose', labelStyle);
      ...
      this.person = game.add.sprite(game.world.centerX, game.world.centerY, 'pointer');
